...
public final class GreaterThanMatcherTest {
    ...
    public void testEquals() {
        final Predicate<OpenNode<? extends Integer, ?>> matcher0 = GreaterThanMatcher.create(3);
        final Predicate<OpenNode<? extends Integer, ?>> matcher1 = GreaterThanMatcher.create(3);
    ...
    public void testNotEquals0() {
        final Predicate<OpenNode<? extends Integer, ?>> matcher0 = GreaterThanMatcher.create(3);
        final Predicate<OpenNode<? extends Integer, ?>> matcher1 = GreaterThanMatcher.create(5);
